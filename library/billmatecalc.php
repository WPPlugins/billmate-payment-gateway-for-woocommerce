...
/**
 * BillmateCalc provides methods to calculate part payment functions.
 *
...
class BillmateCalc {
     ...
     * @param  BillmatePClass  $pclass  {@link BillmatePClass PClass} used to calculate the APR.
     ...
     *
     * @param  float         $sum     The sum for the order/product.
     * @param  BillmatePClass  $pclass  {@link BillmatePClass PClass} used to calculate total credit cost.
     * @param  int           $flags   Indicates if it is the checkout or a product page.
     * @throws BillmateException
     ...
     * @param  BillmatePClass  $pclass  {@link BillmatePClass PClass} used to calculate monthly cost.
     * @param  int           $flags   Indicates if it is the checkout or a product page.
     * @throws BillmateException
    ...
    /**
     * Returns the lowest monthly payment for Billmate Delbetalning.
     *
